...
//Дайте прототипу Vector два метода, plus и minus, которые принимают другой вектор в качестве параметра и возвращают новый вектор,
...
Vector.prototype.plus = function (otherVector){
    let xx = this.x + otherVector.x;
    let yy = this.y + otherVector.y;
